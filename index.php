...
<select class="form-control" name="language" id = "langu">
...
<textarea class="form-control" name="code" id="code" rows="10" cols="50">
#include<stdio.h>
void main()
{
...
<script type="text/javascript">
 ...
 $('#langu').change(function() {
	$summa = $('#langu option:selected').text();
	if($summa=='C++'||$summa=='C++11')
	{
  $('#code').text( "#include<iostream>\nint main()\n{\n\nreturn 0;\n}");
	}
	if($summa=='Java')
	{
		$('#code').text( "class Main\n{\npublic static void main(String args[])\n{\nSystem.out.println(\"Hello World\");\n}\n}");
	}
	if($summa=='C')
	{
  $('#code').text( "#include<stdio.h>\nvoid main()\n{\n\n}");
	}
	if($summa=='Python2' || $summa=='Python3')
	{
  $('#code').text( " ");
	}
})
...
<b>Online Compiler - OS project</b><br>
<b>Developed By Ajith Kumar and Nithesh</b>
